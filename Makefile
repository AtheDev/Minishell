...
SRCS = srcs/main.c srcs/env.c srcs/get_env.c srcs/gnl.c srcs/analysis_input.c \
	...
	srcs/redir.c srcs/cmd.c srcs/split_cmd.c srcs/process_shell.c \
	...
	srcs/signal.c srcs/history.c srcs/builtin/cd_utils.c srcs/env_utils.c \
	srcs/edit_utils.c srcs/dollar2.c srcs/process_shell_utils.c \
	srcs/redirect_utils.c srcs/read_utils.c
